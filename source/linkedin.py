...
linkedin = load_yaml(os.path.join(root_folder, "config", "linkedin.yaml"))
    ...
    def scrape(self, company_list):
        ...
        for company in company_list:
            ...
            try:
                ...
                print(
                    f"Scraped {company}: {results[company]['open_jobs']} open jobs over {results[company]['tot_employees']}"
                )
                sleep(5)
            except:
                pass
...
if __name__ == "__main__":
    ...
    old = (
        ...
        .rename(columns={"Unnamed: 0": "company"})
        .set_index("company")
    )
